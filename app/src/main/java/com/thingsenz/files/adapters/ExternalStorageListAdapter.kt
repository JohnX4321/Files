...
class ExternalStorageListAdapter(val externalStorageFileList: List<ExternalStorageFilesModel>): RecyclerView.Adapter<ExternalStorageListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val esfm=externalStorageFileList[position]
    ...
    override fun getItemCount(): Int {
        return externalStorageFileList.size
    }
